...
\underline{Sammeln von Informationen} Werden die Mitarbeiter von den Mitgliedern des Infiltrationsteams befragt werden sie er"offnen, da\3 bereits alle Informationen zum Unternehmen nicht mehr in der Forschungseinrichtung zu finden sind. Fast alle Gegenst"ande wurden ebenfalls bereits abtransportiert. Die Einrichtung wird gerade aufgegeben da die Forschungen abgeschlossen sind. Die Ermittler k"onnen jetzt versuchen die Mitglieder der fForschungseinrichtung einzusch"uchtern und zu verh"oren. Ein Psychonaut kann dabei gute Dienste leisten. Bie einer Befragung werden die Mitarbeiter zun"achst jede Informationsfreigabe verweigern da sie auf Unterst"utzung von Einsatzkr"aften hoffen. W"ahrend des Verh"ors durch die Charaktere wird dazu Francis McDonald versuchen einen stillen Alarm auszul"osen und die Konzernsicherheit auf den Plan zu rufen. Alternativ zu einem Verh"or vor Ort k"onnen die Ermittler versuchen einen oder alle Mitarbeiter aus der Zone zu schaffen. 
...
\underline{Es wird hei\3} W"ahrend die Charaketere versuchen Informationen zu sammel spitzt sich die Lage zu. 

\underline{Smidth--Singer} Smith--Singer der durch die Vorkommnisse im Blackhole und im Ice Club informiert ist wartet auf den n"achsten Schritt der Investigatoren. Haben die Infiltratoren die Einrichtung "uber den Raumhafen der Zone betreten sind die Konzerngardisten von Smith--Singer direkt informiert, da\3 der Verdacht besteht Cyberbrain k"onnte angegriffen werden. Hat das Luna--Syndikat einen tempor"aren Ausfall der Stromversorgung erzeugt versuchen die Sicherheitskr"afte zun"achst den Ursprung und die Auswirkungen festzustellen. Den Charakteren bleibt dann mehr Zeit. Fr"uher oder spr"ater werden die Konzerngardisten versuchen in die Cybewrbrain Einrichtung einzudringen. Smith--Singer wird darauf dr"angen die Situation gewaltsam zu kl"aren unter anderem um dem im Orbit wartenden Schlachkreuzer einen Grund zu geben Bodentruppen zu senden und die Lage mit dem Proteaktorat und Cynarion auf der einen Seite und dem Konzernrat mit seinen Kriegsschiffen auf der anderen Seite eskalieren zu lassen. 

\underline{Eintreffen der Konzerngardisten} Die Konzerngardisten treffen zum Zeitpunkt fr"uhestens nach den ersten Befragungen der Neurointelligence Mitarbeiter ein und umstellen das Geb"aude. "Uber das Netz der Energieversorgung informiert \xl{} die Infiltrationsgruppe, da\3 sie Besuch bekommen. Kurz darauf kehren die S"oldner von der Absicherung des Geb"audes zur"uck. Die Gardisten fordert die Infiltrationsgruppe auf das Geb"aude zu verlassen und sich zu ergeben. 

\underline{Der Attent"ater} Werden die Charaktere von einem Omega Trupp begleitet tritt Thunder der Attent"ater in Aktion. Er z"undet die im Geb"aude von ihm verteilten Granaten und feuert sofort mit seiner Multigun von hinten auf Stormball um diesen auszuschalten. Daraufhin wirft er sich in Deckung. 

\underline{Das Geb"aude wird gest"urmt} Im Falle des Angriffs durch den Omega wird dem Sicherheittrupp von Smidth--Singer befohlen das Geb"aude sofort zu st"urmen. Ist kein Attent"ater im Geb"aude kann der Spielleiter zun"achst eine Verhandlung mit den Geiselnehmern im Geb"aude initiieren. In jedem Fall werden die Gardisten f"uher oder sp"ater beginnen die T"uren zu entriegeln. Die Sprengfallen an den T"uren schalten einen Teil des Sicherheitstrupps aus. \xl{} informiert die Infiltrationsgruppe "uber das Vorgehen des Sicherheitstrupps. Der Sicherheitstrupp der versucht "uber ein nicht durch eine Falle gesichertes Tor einzudringen wird nach dem sie das Geb"aude betreten haben im Zweifelsfalle von \xl{} von hinten ausgeschaltet. \xl{} wird nur auf den Plan treten wenn keiner der Charaktere sie sehen kann. Treffen die Charaktere auf die Leichen kann das nat"urlich Fragen aufwerfen. Gehen die Infiltrationen nich zum Gegenangriff "uber oder finden eine M"oglichkeit in die Wartungstunnel zu gelangen wird eine zwei Gruppe von Gardisten angef"uhrt von Smidth--Singer versuchen das Geb"aude zu st"urmen. Sie setzen Schock und Rauchgranaten ein.
...
\begin{description}
	\item [Durch den Boden] Die Charaktere k"onnen versuchen sich im Geb"aude zu verschanzen und sich durch den Boden in die 		
		Wartungssch"achte zu brennen.
	\item [Im ersten Stock] Haben sich die Charaktere im ersten Stock verschanzt k"onnen sie versuchen sich durch die Wand 		  	zu brennen.
	\item [Der Hinterausgang] Die nicht beim ersten Eintreffen get"oteten Gardisten versuchen nur noch "uber das Foyer 		
		einzudringen. Im hinteren Bereich sind alle Angreifer tot.
\end{description}
...
Gelingt den Charakteren die Flucht werden sie vorraussichtlich die Zone auf dem Gel"ande des Luna--Syndikats verlassen und dort auch als erstes Unterschlupf suchen. 

\underline{Die Medien} Wenn die Charaktere die Wartungstunnel verlassen wird "uber die Medien auf Valhalla eine Eilmedung verbreitet. Es wird verk"undet, da\3 ein Angriff auf eine hoch sensible Konzerneinrichtung stattgefunden hat. Im Hinblick darauf, da\3 es bereits in der Vergangenheit vermehrt zu Anschl"agen gekommen ist und zudem hohe W"urdentre"ager in wenigen Stunden in der Stadt erwartet werden hat der Konzernrat beschlossen Sicherheitskr"afte aus dem vor kurzen eingetroffenen Eskortschiff zu entsenden die die Sicherheit in den sensiblen Zonen von Vallhalla sicher stellen sollen. Die Sicherheitskr"afte werden mit voller Authorit"at den Stadtbereich absichern und Kontrollen durchf"uhren. Den Sicherheitskr"aften ist auf jeden Fall folge zu leisten.
...
\underline{\ml{}} Nach dem Die Charaktere in Deckung gegangen sind k"onnen sie \ml{} und die anderen Mitarbeiter weiter befragen. Die Information der anderen Mitarbeiter sind im vorhergegangenen Kapitel beschrieben. 

\ml{} ist bereit folgende weiter Informationen bereit zu stellen:
...
\begin{description}
	...
	\item[Sponsoring] Die Neurointelligence wird durch die USI quer finianziert und mit weit entwickelter KI Technologie unterst"utzt. Die 		genauen Vereinbarungen zwischen Neuro Intelligence und USI kennt \ml{} allerdings nicht.
	\item[Cyberbrain] Cyberbrain wurde als Vorort Dependence auf Kallisto von Neuro Intelligence geschaffen. Die Einrichtung wird ist wohl 
		ebenfalls von der USI bereit gestellt worden.
	\item[Freie KI] Nach dem \ml{} die Manipulation der KIs durch die USI aufgedeckt hat konnte sie eine neue freie Version des KI Codes 	
		erschaffen. Die neue KI wurde bereits an Menschen die sie aber nicht kennt erprobt. Ihres Wissens nach stammten die Probanten aus einem Gef"angnis auf Valhalla. Die Software der freien KIs befindet sich in ihrem B"uro auf Nike.
	\item[USI KIs] Die USI betreibt wohl seit l"angerem KI Forschung und setzt KIs auch in der Kriegsf"uhrung ein. Alle diese KIs werden 
...
\begin{description}
	\item[Offenlegung der Informationen] Das offenlegen der Informationen zur Beziehgun von Neuro Intelligence und der Cynarion in Richtung	
		Cynarion oder dem Protektorat ist ganz offensichtlich sehr heikel. Blackheart wird m"oglichweise vermuten das Cynarion selbst in die Manipulation der Attent"ater verstrickt ist. Cynarion wird versuchen die Sache zu verschleiern.
	\item[Identifikation der Attent"ater] Durch Nachfragen in der Rondra Klinik oder beim Protektoratsmilit"ar erfahren die Charaktere, 	
		da\3 Prof.~Dr.~Sander in seinem Haus verstorben ist. M"oglichst ohne Offenlegung ihrer Identit"at oder ihres Aufeinthaltsortes m"ussen die Charaktere versuchen "uber die nun stellvertretende Leiterin der Rondra Klinik Brenda Ben heraus zu finden wer die restelichen Attent"ater sind.
	\item[Verhinderung des Attentats auf der Gala] Die Charaktere m"ussen versuchen das Attentat auf der Gala entweder selbst oder mit 
		MNittelsm"annern versuchen zu vewreiteln.
	\item[Die Guardiankreuzer] "Uber den Virus den \ml{} auf Nike erstellen kann k"onnen die Guardian Kreuzer "ubernommen werden.
\end{description}

Treten die Charaktere mit dem Protektoratsmilit"ar in Kontakt wird ihnen befohlen unter zu tauchen. Gegen"uber dem Vorgehen des Guardiankreuzers werden entsprechende Ma\3nahmen seitens des Protektorats in die Wege geleitet um die Sicherheit und Souver"anit"at auf Valhalla sicher zu stellen.

Treten die Charaktere mit Cynarion in Kontakt wird Ihnen ebenfalls geraten unter zu tauchen. Cynarion wird weitere Schritte einleiten.

\subsection{Einnahme von Valhalla}
