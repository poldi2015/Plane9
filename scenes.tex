...
Bei den Nchforschungen au\3erhalb \emph{Headquarter}, \emph{Rosenfurth} und dem Raumhafen werden die Soldaten aus der Garnison die Ermittler nicht weiter begleiten. An den R"ander von \emph{Paradise City} und \emph{Neu Gr"oning} endet der Einflu\3bereich des Protektorats und man will Spannungen vermeiden. Die Charaktere bekommen ein Sprechfunkger"at an die Hand um den St"utzpunkt im Zweifel erreichen zu k"onnen.

\begin{remarks}
	Bei den Nachforschungen in den Kliniken werden die Charaktere keine neuen Erkenntnise gewinnen.
\end{remarks}
...
"`Meine Zeit ist leider sehr begrenzt. Deshalb gleich zur Sache. Was suchen Sie hier auf Valhalla?'' Bitte fassen Sie sich kurz damit ich schnell entscheiden kann wie es mit Ihnen weiter geht.''.
