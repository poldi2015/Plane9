...
\newlength{\printinner}
\setlength{\printinner}{10mm}                 % Cut away at inner (incl. Kleberand)
\newlength{\printouter}
\setlength{\printouter}{3mm}                  % Cut away at outer (incl. Kleberand)
\newlength{\printextend}
\setlength{\printextend}{1mm}                 % Dimension how much bigger images should be around the page side
...
\pageimage{images/cmyk/jovian_system_cmyk.jpg}
