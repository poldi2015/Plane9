...
Gelinkt es den Charakteren Nike anzufliegen k"onnen sie am Raumdock oder auch direkt an der Plan 9 andocken.
...
\subsection{Angedeockt an der Plane 9}
...
\subsection{In den R"aumen der Neuro Intelligence}
...
\newsection{Prof.~Dr.~Naratova - Antwort auf alle Fragen}
...
Sie "ubertr"agt \ml{} den Codes. In den R"aumen der Neuro Intelligence steht \ml{} ein mobiler Computer zur Verf"ugung auf dem sie ihr KI zu einem Virus umprogrammieren kann. Der Gruppe bleibt nicht viel Zeit eine Entscheidung zu treffen. \xl{} ist bereit mit den Ermittlern und ihrem Schiff zur Zeuss II-2 "uber zu setzen und es mit der fremden KI aufzunehmen. Sie erkl"art der Gruppe, dass sie die Einzige ist die stark genug ist den USI Code zu bezwingen und auch die Einzige die der frei gewordenen KI ein Angebot zur Kooperation anzubieten kann, dass sie nicht ablehnen kann. Die Frage ist ob die Charaktere ihr vertrauen den Krieg in ihrem Interesse zu beenden.

\begin{remarks}
	In dieser Szene werden alle noch offenen Fragen geklärt und die letzten Entscheidungen getroffen. Prof.~Dr.~Naratove legt ihre Pl"ane offen, kann Fragen beantworten und gesteht ihr Fehlverhalten ein. Die Szene ist damit der H"ohepunkt der Geschichte mit der Melancholie eines tragischen Endes. Der Beginn der Szene ist dominiert durch den Dialog zwischen der Firmenchefin, \ml{} und \ml{} und den R"uckmeldungen von der Donar und der Nike Station. Die Dialoge m"ussen durch den Spielleiter z"ugig vorgetragen werden um den Spannungsbogen aufrecht zu erhalten.
	...
	Wenn Prof.~Dr.~Naratova \xl{} enttarnt ist es m"oglich einem Charakter der vorher im Asteroideng"urtel zwischen Mars und Jupiter t"atig war zu erkennen, dass \xl{} die ber"uchtigte Piratin ist die auf Valhalla gefangen genommen wurde und kann darus schlie\3en, dass sie dort in der Gefangenschaft die KI implantiert bekommen hat.

	F"ur das weitere Vorgehen bleiben Den Charakteren zwei Optionen. Entweder sie bitten \ml{} einen Virus zu erstellen die die angegriffene KI zerst"ort oder einen Virus der den USI Code entfernt. Die entg"ultige Entscheidung unterleigt allerdings am Ende \ml{}. Schenken die Ermittler \xl{} genug Vertrauen entwickelt \ml{} den Code der die KI befreit. \xl{} eitf in jedem Fall versuchen die Zeuss II-2 zu kapern. Ist die Gruppe nicht bereit \xl{} zu vertrauen m"ussen sie sie "uberrumpeln und unsch"adlich machen. \xl{} wird in diesem Falle versuchen \ml{} in ihre Gewalt zu bringen und mit der Dragon Blade zur Zeuss II-2 zu fliehen.
\end{remarks}