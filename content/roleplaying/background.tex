...
\item [Shigano-Kombinat] Das Shigano-Kombinat ist ein Konzernkonglomerat auf dem Mars, spezialisiert auf die Z"uchtung von Mutanten. Es 
      bietet ebenfalls ein hochentwickeltes Spektrum an Cybertechnologie an. Das Shigano-Kombinat entstand aus einer Abspaltung vom Japanischen Kaiserreichs.
...
\item [Vereinte Nationen] Die Vereinten Nationen sind das oberste Gremium der Nationalstaaten im Sonnensystem. Das Shigano-Kombinat strebt 
      eine Mitgliedschaft an. Das Protektorat ist ebenfalls noch kein Mitglied.
\end{description}
...
\item [Nemessis] Nemesis ist der Pate des Luna-Syndikats auf Kallisto. Er tr"agt den Titel ``Der Duke von Valhalla''. Er ist ein 
      Slag-Cyborg. 
