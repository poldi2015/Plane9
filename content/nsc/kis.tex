...
\begin{description}
    ...
    \item[Artisan] ist der Erste, der im Rondra Hospital operiert wird. Bei ihm wird der w"ahrend des Aufenthalts auf Kallisto 
        besch"adigtes Kontrollmodul getauscht. Artisan wird 7 Wochen, d.h.~1\sfrac{1}{2} Monate vor der Zusammenkunft der Ermittler operiert und "ubernimmt nach seiner R"uckkehr nach Armageddon drei Wochen sp"ater die Leitung der Attentate.
