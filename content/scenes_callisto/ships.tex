...
\begin{remarks}
    Wurden beim Angriff auf das Cyberbrain Institut neben \ml{} weitere Mitarbeiter gefangen genommen, sollten diese beim Flug zur Nike Station nicht mitgenommen werden, um den Spielverlauf nicht zu erschweren. 
\end{remarks}
