...
\speak{Ich hoffe, euch ist klar, dass die Situation ernsthafte Ausma\3e angenommen hat. Ein falsches Wort an falscher Stelle, und Valhalla steht in Flammen—mit euch mittendrin.}
...
\speak{Selbst, wenn dem so w"are? Was w"urdet dann an unserem Verh"altnis "andern? Ich habe euch bisher unterst"utzt. Wollen wir an diesem Verh"altnis etwas "andern?} 
