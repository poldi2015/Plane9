...
Unabh"angig davon f"ur welche Option sich die Spieler entscheiden stehen den Ermittlern fr"uher oder sp"ater unerwartet 9 Gangster angef"uhrt von \xl{} gegen"uber. \xl{} und ihre Bande ist im Auftrag von Nemessis ausgesandt die Gruppe zu ihm zu bringen. Sie allerdings wird zuerst versuchen m"oglichst viel "uber den Wissensstand der Gruppe in Erfahrung zu bringen. Die Gangster bis auf \xl{} halten Multiguns in den H"anden. \xl{} tritt den Charakteren ohne eine Waffe in der Hand einen Schritt entgegen. Sie herrscht den Charakter der ihr direkt gegen"uber steht an.

%
% Kommt der Chefermittler oder sein Assistent aus dem G"urtel oder ist mit Polizeiaufgaben bei Cynarian betraut kann der Spielleiter
% bei dieser ersten Begebnung einen Gl"uckwurf ohne Begr"undung werfen lassen. Bei einem vollen Erfolgt kommt ihm \xl{} von einem 
% Fahndungphoto her bekannt vor bzw. hat erfahren, dass sie vor ein paar Monaten festgenommen wurde.
%
...
\xl{} wird zun"achst abwarten welche Informationen die Gruppe bereit ist zu geben. Tritt der Omega in Aktion wird sie sich auf Abstand begeben und sich an diesen wenden. Geben die Charaktere keine weiteren Informationen preis wendet sie sich ebenfalls an den Omega.
...
\xl{} bringt sich bei der Auseinandersetzung au\3er Reichweite. Die Gangster den Rest der Gruppe in Schach halten bleiben auf Abstand. Egal wie der Kampf ausgeht wird \xl{} die Charaktere "uberzeugen, dass die Gruppe nicht ohne Verluste aus einer weiteren Konfrontation heraus kommen werden. Die Waffen der verbliebenen Angreifer sind mit scharfer Munition geladen, behauptet sie. Wichtig in jedem Fall ist das \xl{} am Ende die Kontrolle beh"alt. Wenn der Omega ausgeschaltet wurde und die Gangster nach wie vor in der "Uberzahl sind kann \xl{} ein weiteres Mal versuchen mehr Informationen aus den Ermittlern zu pressen.
...
Nach Beendigung der der Audienz wird die Gruppe durch \xl{} in die Lobby des Suushine Hotels gef"uhrt. Auf dem Weg dahin werden ihnen die Fesseln abgenommen. Im Raum befinden sich bereits einige Angestellten des Dukes wie auch ein "alterer Mann in einem Arztkittel. \xl{} bedeutet dem Arzt, der sich als Dr.~\pinyin{Li4} \pinyin{Li4} vorstellt, etwaige Wunden zu versorgen.

\begin{remarks}
	Gewonnene Information: Kontakt Nemessis und \xl{}.
