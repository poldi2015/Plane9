...
\newsection[Das Luna-Syndikat schlägt zu]{Das Luna-Syndikat schlägt zu}
...
\begin{remarks}
	In dieser Szene l"asst sich das Temperament von Blackheart gut ausspielen. Blackheart wird zwar nicht auf ihre Abmachung mit dem Duke eingehen. Allerdings wird der Name Nemessis, \say{Das wird ihm noch leidtun} und \say{Glaubt jetzt jeder, mir auf der Nase herumtanzen zu k"onnen!?} in dem Gespr"ach fallen, das Thunderbolt, der Kontaktmann des Ermittlers, an ihn gefiltert weitergibt.
\end{remarks}
